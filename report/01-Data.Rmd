...
Download it
```{r}
download.file("https://raw.githubusercontent.com/EurousZhao/DST-group_A1/main/Datasets/smoking_driking_dataset.csv?token=GHSAT0AAAAAACIDBPPJRAC65UCEAOLVVV6KZKJHYLA",path_wd("..","data","raw","smoking_driking_dataset.csv"))
```
